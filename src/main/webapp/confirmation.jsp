...
<div class="container">
    <div class="form-container">
        ...
        <div>
            <a href="http://localhost:8080/BankManagementSystems/CardController" class="btn btn-primary">Show Address</a>
        </div>
        <div>
            <a href="http://localhost:8080/BankManagementSystems/CardController" class="btn btn-primary">Show Product</a>
        </div>
        <div>
